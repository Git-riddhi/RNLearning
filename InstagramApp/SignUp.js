...
import { ScrollView, View, StyleSheet, Button, Image, Text, TextInput, Alert, TouchableOpacity, ImageBackground } from 'react-native';
...
const SignUp = ({navigation}) => {
  ...
  const pwd = (password) => {
    var passRegex = /^.*(?=.{6,10})(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*?_~()-]*).*$/
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={require('../assets/bg.png')} resizeMode="cover" style={styles.image}>
        <TouchableOpacity>
          <Image source={require('../assets/arrow.png')} style={styles.leftAerrowButton} />
        </TouchableOpacity>
